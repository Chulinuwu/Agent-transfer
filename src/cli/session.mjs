...
export function runSession({ from, to, id, last, mode, cwd, out: outFile, apply, json, 'no-redact': noRedact, 'tool-output': toolOutput, desktop }) {
  ...
  const options = { cwd: cwd ?? session.cwd, out: outFile, toolOutput, desktop };
